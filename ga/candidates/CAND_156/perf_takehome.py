            ...
            while vi < num_vec_iters:
                if vi + 7 < num_vec_iters:
                    ...
                    for lane in range(0, VLEN, 2):
                        self.instrs.append({
                            "load": [
                                ("load_offset", vec_node_val_e, vec_addr_e, lane),
                                ("load_offset", vec_node_val_e, vec_addr_e, lane + 1),
                            ]
                        })
                    for lane in range(0, VLEN, 2):
                        self.instrs.append({
                            "load": [
                                ("load_offset", vec_node_val_f, vec_addr_f, lane),
                                ("load_offset", vec_node_val_f, vec_addr_f, lane + 1),
                            ]
                        })
