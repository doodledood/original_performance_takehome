        ...
        for round in range(rounds):
            ...
            while vi < num_vec_iters:
                if vi + 7 < num_vec_iters:
                    ...
                    for hi in range(0, len(HASH_STAGES), 2):
                        op1_0, val1_0, op2_0, op3_0, val3_0 = HASH_STAGES[hi]
                        op1_1, val1_1, op2_1, op3_1, val3_1 = HASH_STAGES[hi + 1]
                        const1_vec_0, const3_vec_0 = hash_const_vecs[hi]
                        const1_vec_1, const3_vec_1 = hash_const_vecs[hi + 1]
                        self.instrs.append({
                            "valu": [
                                (op1_0, tmp1, vec_val, const1_vec_0),
                                (op3_0, tmp2, vec_val, const3_vec_0),
                                (op1_0, tmp1_b, vec_val_b, const1_vec_0),
                                (op3_0, tmp2_b, vec_val_b, const3_vec_0),
                                (op1_0, tmp1_c, vec_val_c, const1_vec_0),
                                (op3_0, tmp2_c, vec_val_c, const3_vec_0),
                            ]
                        })
                        self.instrs.append({
                            "valu": [
                                (op1_0, tmp1_d, vec_val_d, const1_vec_0),
                                (op3_0, tmp2_d, vec_val_d, const3_vec_0),
                                (op1_0, tmp1_e, vec_val_e, const1_vec_0),
                                (op3_0, tmp2_e, vec_val_e, const3_vec_0),
                                (op1_0, tmp1_f, vec_val_f, const1_vec_0),
                                (op3_0, tmp2_f, vec_val_f, const3_vec_0),
                            ]
                        })
                        self.instrs.append({
                            "valu": [
                                (op1_0, tmp1_g, vec_val_g, const1_vec_0),
                                (op3_0, tmp2_g, vec_val_g, const3_vec_0),
                                (op1_0, tmp1_h, vec_val_h, const1_vec_0),
                                (op3_0, tmp2_h, vec_val_h, const3_vec_0),
                                (op2_0, vec_val, tmp1, tmp2),
                                (op2_0, vec_val_b, tmp1_b, tmp2_b),
                            ]
                        })
                        self.instrs.append({
                            "valu": [
                                (op2_0, vec_val_c, tmp1_c, tmp2_c),
                                (op2_0, vec_val_d, tmp1_d, tmp2_d),
                                (op2_0, vec_val_e, tmp1_e, tmp2_e),
                                (op2_0, vec_val_f, tmp1_f, tmp2_f),
                            ]
                        })
                        self.instrs.append({
                            "valu": [
                                (op2_0, vec_val_g, tmp1_g, tmp2_g),
                                (op2_0, vec_val_h, tmp1_h, tmp2_h),
                                (op1_1, tmp1, vec_val, const1_vec_1),
                                (op3_1, tmp2, vec_val, const3_vec_1),
                                (op1_1, tmp1_b, vec_val_b, const1_vec_1),
                                (op3_1, tmp2_b, vec_val_b, const3_vec_1),
                            ]
                        })
                        self.instrs.append({
                            "valu": [
                                (op1_1, tmp1_c, vec_val_c, const1_vec_1),
                                (op3_1, tmp2_c, vec_val_c, const3_vec_1),
                                (op1_1, tmp1_d, vec_val_d, const1_vec_1),
                                (op3_1, tmp2_d, vec_val_d, const3_vec_1),
                                (op1_1, tmp1_e, vec_val_e, const1_vec_1),
                                (op3_1, tmp2_e, vec_val_e, const3_vec_1),
                            ]
                        })
                        self.instrs.append({
                            "valu": [
                                (op1_1, tmp1_f, vec_val_f, const1_vec_1),
                                (op3_1, tmp2_f, vec_val_f, const3_vec_1),
                                (op1_1, tmp1_g, vec_val_g, const1_vec_1),
                                (op3_1, tmp2_g, vec_val_g, const3_vec_1),
                                (op1_1, tmp1_h, vec_val_h, const1_vec_1),
                                (op3_1, tmp2_h, vec_val_h, const3_vec_1),
                            ]
                        })
                        self.instrs.append({
                            "valu": [
                                (op2_1, vec_val, tmp1, tmp2),
                                (op2_1, vec_val_b, tmp1_b, tmp2_b),
                                (op2_1, vec_val_c, tmp1_c, tmp2_c),
                                (op2_1, vec_val_d, tmp1_d, tmp2_d),
                                (op2_1, vec_val_e, tmp1_e, tmp2_e),
                                (op2_1, vec_val_f, tmp1_f, tmp2_f),
                            ]
                        })
                        self.instrs.append({
                            "valu": [
                                (op2_1, vec_val_g, tmp1_g, tmp2_g),
                                (op2_1, vec_val_h, tmp1_h, tmp2_h),
                            ]
                        })
